...
public enum NonTeachingLoadType
{
    ...
    [LoadCategory(Category = "Formation", PromtName = "Formación", Description = "Proceso clave de Formación académica.")]
    Consultation,
    ...
    [LoadCategory(Category = "Others", PromtName = "Otras actividades", Description = "Otras actividades")]
    Meetings,
    ...
    [LoadCategory(Category = "Research", PromtName = "Investigación", Description = "Proceso clave de investigación.")]
    ...
    [LoadCategory(Category = "UniversityExtension", PromtName = "Extensión universitaria", Description = "Proceso clave de extensión universitaria.")]
