...
public class GetCoursesRangeHandler(ICoursesManager coursesManager, IMapper mapper) : IRequestHandler<GetCoursesRangeRequest, GetCoursesRangeResponse>
{
    private readonly ICoursesManager _coursesManager = coursesManager;
    private readonly IMapper _mapper = mapper;

    public async Task<GetCoursesRangeResponse> Handle(GetCoursesRangeRequest request, CancellationToken cancellationToken)
    {
        try
        {
