...
public class GetCoursesForDepartmentHandler(ICoursesManager coursesManager, IMapper mapper) : IRequestHandler<GetCoursesForDepartmentRequest, GetCoursesForDepartmentResponse>
{
    private readonly ICoursesManager _coursesManager = coursesManager;
    private readonly IMapper _mapper = mapper;

    public async Task<GetCoursesForDepartmentResponse> Handle(GetCoursesForDepartmentRequest request, CancellationToken cancellationToken)
    {
        try
        {
