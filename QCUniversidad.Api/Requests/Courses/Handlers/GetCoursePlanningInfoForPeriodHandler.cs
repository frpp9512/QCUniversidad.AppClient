...
public class GetCoursePlanningInfoForPeriodHandler(ICoursesManager coursesManager,
                                                   IPeriodsManager periodsManager,
                                                   IMapper mapper) : IRequestHandler<GetCoursePlanningInfoForPeriodRequest, GetCoursePlanningInfoForPeriodResponse>
{
    ...
    public async Task<GetCoursePlanningInfoForPeriodResponse> Handle(GetCoursePlanningInfoForPeriodRequest request, CancellationToken cancellationToken)
    {
        try
        {
