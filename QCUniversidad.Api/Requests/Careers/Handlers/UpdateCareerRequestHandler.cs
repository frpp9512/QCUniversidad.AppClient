...
public class UpdateCareerRequestHandler(ICareersManager careersManager, IMapper mapper) : IRequestHandler<UpdateCareerRequest, UpdateCareerRequestResponse>
{
    private readonly ICareersManager _careersManager = careersManager;
    private readonly IMapper _mapper = mapper;

    public async Task<UpdateCareerRequestResponse> Handle(UpdateCareerRequest request, CancellationToken cancellationToken)
    {
        try
        {
