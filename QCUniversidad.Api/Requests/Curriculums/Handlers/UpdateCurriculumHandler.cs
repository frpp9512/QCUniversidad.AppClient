...
public class UpdateCurriculumHandler(ICurriculumsManager curriculumsManager, IMapper mapper) : IRequestHandler<UpdateCurriculumRequest, UpdateCurriculumResponse>
{
    private readonly ICurriculumsManager _curriculumsManager = curriculumsManager;
    private readonly IMapper _mapper = mapper;

    public async Task<UpdateCurriculumResponse> Handle(UpdateCurriculumRequest request, CancellationToken cancellationToken)
    {
