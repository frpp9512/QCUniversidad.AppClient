...
public class GetCurriculumsRangeHandler(ICurriculumsManager curriculumsManager, IMapper mapper) : IRequestHandler<GetCurriculumsRangeRequest, GetCurriculumsRangeResponse>
{
    private readonly ICurriculumsManager _curriculumsManager = curriculumsManager;
    private readonly IMapper _mapper = mapper;

    public async Task<GetCurriculumsRangeResponse> Handle(GetCurriculumsRangeRequest request, CancellationToken cancellationToken)
    {
        try
        {
