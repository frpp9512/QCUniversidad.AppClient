...
public class GetDepartmentsRangeHandler(IDepartmentsManager departmentsManager, IMapper mapper) : IRequestHandler<GetDepartmentsRangeRequest, GetDepartmentsRangeResponse>
{
    private readonly IDepartmentsManager _departmentsManager = departmentsManager;
    private readonly IMapper _mapper = mapper;

    public async Task<GetDepartmentsRangeResponse> Handle(GetDepartmentsRangeRequest request, CancellationToken cancellationToken)
    {
        try
        {
