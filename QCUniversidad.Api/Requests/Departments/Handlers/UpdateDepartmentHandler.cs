...
public class UpdateDepartmentHandler(IDepartmentsManager departmentsManager, IMapper mapper) : IRequestHandler<UpdateDepartmentRequest, UpdateDepartmentResponse>
{
