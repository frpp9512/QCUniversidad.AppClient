...
public class GetDepartmentsOfFacultyHandler(IDepartmentsManager departmentsManager, IMapper mapper) : IRequestHandler<GetDepartmentsOfFacultyRequest, GetDepartmentsOfFacultyResponse>
{
    private readonly IDepartmentsManager _departmentsManager = departmentsManager;
    private readonly IMapper _mapper = mapper;

    public async Task<GetDepartmentsOfFacultyResponse> Handle(GetDepartmentsOfFacultyRequest request, CancellationToken cancellationToken)
    {
        try
        {
