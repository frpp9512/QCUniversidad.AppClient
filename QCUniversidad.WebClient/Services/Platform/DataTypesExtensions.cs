...
public static class DataTypesExtensions
{
    ...
    public static Guid GetFullname(this ClaimsPrincipal user)
        => new(user.Claims.First(c => c.Type == ClaimTypes.Name).Value);

    public static Guid GetEmail(this ClaimsPrincipal user)
        => new(user.Claims.First(c => c.Type == ClaimTypes.Email).Value);
    ...
    public static Guid GetFacultyId(this ClaimsPrincipal user)
        => new(user.Claims.First(c => c.Type == "FacultyId").Value);
