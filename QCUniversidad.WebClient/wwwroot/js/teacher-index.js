var deleteModal = new bootstrap.Modal(document.getElementById('deleteTeacherModal'), { keyboard: true });
requesting = false;

function RiseDeleteModal(id) {
    var faculty = GetTeacherName(id);
    SetDeleteModalTextContent("¿Esta seguro que desea eliminar el profesor '" + faculty + "'?");
    var button = document.getElementById("modal-delete-primarybutton");
    button.onclick = function () {
        SendTeacherDepartmentRequest(id);
    };
    deleteModal.show();
}
