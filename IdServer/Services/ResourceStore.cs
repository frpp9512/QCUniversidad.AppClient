...
namespace IdServer.Services
{
    public class ResourceStore : IResourceStore
    {
        ...
        public ResourceStore(IdServerDataContext dataContext)
        {
        ...
        {
            return await FindApiResourcesByNameAsync(scopeNames);
            //var storedResources = new List<StoredApiResource>();
            //foreach (var name in scopeNames)
            //{
            //    var founded = await _dataContext.ApiResources.Include(x => x.Scopes)
            //                                                 .Include(x => x.UserClaims)
            //                                                 .FirstOrDefaultAsync(x => x.Scopes.Any(y => y.Scope == name));
            //    if (founded is not null)
            //    {
            //        storedResources.Add(founded);
            //    }
