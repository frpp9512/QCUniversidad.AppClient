...
namespace IdServer.Data.Context
{
    public class IdServerDataContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<StoredClient>()
                        .HasMany(x => x.Secrets)
                        .WithOne(x => x.Client)
            ...
            modelBuilder.Entity<StoredApiResource>()
            ...
            modelBuilder.Entity<StoredIdentityResource>()
                        .HasMany(x => x.UserClaims)
                        .WithOne(x => x.StoredIdentityResource)
                        .OnDelete(DeleteBehavior.Cascade);

            modelBuilder.Entity<StoredApiScope>()
                        .HasMany(x => x.UserClaims)
            ...
            modelBuilder.Entity<StoredUserClientRoles>()
