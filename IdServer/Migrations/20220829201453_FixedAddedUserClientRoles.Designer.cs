...
namespace IdServer.Migrations
{
    ...
    [Migration("20220829201453_FixedAddedUserClientRoles")]
    partial class FixedAddedUserClientRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdServer.Data.Models.StoredClientPostLogoutRedirectUris", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("StoredClientPostLogoutRedirectUris");
                });
            ...
            modelBuilder.Entity("IdServer.Data.Models.StoredUserClientRoles", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("StoredUserClientRoles");
                });
            ...
            modelBuilder.Entity("IdServer.Data.Models.StoredUserClientRoles", b =>
                {
                    b.HasOne("IdServer.Data.Models.StoredClient", "StoredClient")
                        .WithMany("StoredUserClientRoles")
                        .HasForeignKey("StoredClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IdServer.Data.Models.StoredClient", b =>
                {
                    ...
                    b.Navigation("StoredUserClientRoles");
                });
